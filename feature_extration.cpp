...
int main ( int argc, char** argv )
{
   ...
   //   Mat img_1 = imread ( argv[1], CV_LOAD_IMAGE_GRAYSCALE );
    ...
    cv::namedWindow("SIFT特征点", CV_WINDOW_NORMAL); 
    imshow("SIFT特征点",outimg1);
    cv::imwrite( "SIFT特征点.png", outimg1 );
    //v::waitKey( 1 );
    ...
    cv::imwrite( "所有匹配点对.png", img_match );
    cv::namedWindow("优化后匹配点对", CV_WINDOW_NORMAL);  
    imshow ( "优化后匹配点对", img_goodmatch );
    cv::imwrite( "优化后匹配点对.png", img_goodmatch );
    waitKey(0);
